  ...
  return (
    <SignInWrapper onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className="flex flex-row justify-between">
        <div className="flex flex-row" style={{marginLeft: '5%', marginTop: '10px'}}>
          <input type="checkbox" id="remember_me" checked={true}/>
          <label className="other-label">Remember me</label>
        </div>
        <div className="flex flex-row" style={{marginRight: '5%', marginTop: '10px'}}>
        <label className="other-label">Forgot Password? </label>
        <label className="reset-label"> Reset Now</label>
        </div>
      </div>
